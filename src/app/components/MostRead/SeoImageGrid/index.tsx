  ...
  const data = [
    {
      type: 'article',
      isLive: true,
      title: 'Champions League: Manchester City and Real Madrid dey among di 16 teams',
      firstPublished: '2025-02-11T09:57:42.029Z',
      lastPublished: '2025-02-13T10:52:48.687Z',
      link: 'https://www.bbc.com/pidgin/articles/cq8k9lqxyd8o',
      imageUrl:
      ...
      description:
        'Di two-leg Champions League knockout phase play-offs start dis week, Manchester City and Real Madrid dey among di 16 teams wey don dey hope to reach di last 16.',
      imageAlt: 'Manchester City and Real Madrid Champions League match preview',
      id: 'cq8k9lqxyd8o',
    },
    {
      type: 'article',
      ...
      description:
        'Oda stars wey show for New Orleans include Jay-Z, Blue Ivy, Samuel L Jackson and Bradley Cooper.',
      imageAlt: 'Kendrick Lamar, Donald Trump, and other celebrities at the Super Bowl',
      id: 'cew5rdyv8xno',
    },
  ];
        ...
        {data.map((item) => (
          <article key={item.id}>
            <a href={item.link} style={{ textDecoration: 'none', color: 'inherit' }}>
              <img
                id={`t4Image-${item.id}`}
                src={item.imageUrl.replace('{width}', '600')}
                alt={item.imageAlt}
